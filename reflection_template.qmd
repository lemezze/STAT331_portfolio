...
[**My Grade:**]{.underline} I believe my grade equivalent to course work evidenced below to be a \_\_ so far.
...
```{r wd-1-xlsx}
# Practice Activity 3
per_capita <- read_xlsx("gov_spending_per_capita.xlsx")
```
...
```{r wd-4-numeric}
# Practice Activity 1, Question 6
