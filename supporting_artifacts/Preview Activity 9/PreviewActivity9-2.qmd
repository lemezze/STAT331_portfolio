...
# lower.tail = FALSE because looking at the lower.tail
```
...
# Probability of 7/1000 and essentially calculating a p value from 4532 
pnorm(q = 7/1000/4532, mean = 0, sd = 1, lower.tail = TRUE)
```
